import { opExpr } from './compiled-predicate.js';
import { isOperatorKnown } from './operators-registry.js';
import { createJsonPathPlan } from './data-engine.js';
let canCompile = null;
...
let cacheMax = 2000;
export function setCompiledMutationCacheLimit(limit) { cacheMax = Math.max(0, limit | 0); }
export function clearCompiledMutationCache() { factoryCache.clear(); }
...
export function isFlatMutationCodegenable(criteria, actions) {
...
export function compileFlatMutation(criteria, actions) {
